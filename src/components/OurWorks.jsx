    ...
    <>
      <div className="container xl:max-w-[1320px] mx-auto md:px-6 px-4">
        <div className="md:flex lg:gap-0 md:gap-10 gap-6 justify-between items-end">
          <div
            className="lg:pt-[27px] lg:pb-[23px] py-3 xs:px-10 px-6 bg-stone-300 bg-opacity-0 border border-sky-900 md:flex flex-col items-center justify-between xl:w-[141px] sm:w-[100px] xs:w-[40px] w-[25px] lg:h-[420px] h-[300px] hidden"
            data-aos="fade-right"
          ...
          <div
            className="xs:ps-[27px] xs:pe-[23px] p-3 bg-stone-300 bg-opacity-0 border border-sky-900 flex items-center justify-between w-full md:hidden mb-10"
            data-aos="fade-left"
            data-aos-duration="1000"
            data-aos-easing="linear"
          >
